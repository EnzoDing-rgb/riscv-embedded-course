...
**硬件（全班统一）**：RISC-V 开发板（推荐 [RevyOS 支持硬件](https://github.com/ruyisdk/support-matrix) 中的 Lichee Pi 4A / Milk-V Meles / 同档次板卡）+ I2C 温湿度（如 SHT30/AHT20）+ 1 颗 LED（异常指示）。无硬件板卡可用 QEMU 仿真。
